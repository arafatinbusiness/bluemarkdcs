...
import { MessageCircle, Briefcase, FileText, Building, Star, Scale, ArrowLeft, Phone, Mail } from 'lucide-react';
      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <button
              onClick={handleBack}
              className="flex items-center gap-2 text-gray-600 hover:text-[#C41E3A] transition-colors mb-6"
            >
              <ArrowLeft size={20} />
