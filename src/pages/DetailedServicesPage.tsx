...
import { ChevronRight, Briefcase, FileText, Building, Star, Scale, ArrowLeft } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-12">
            <div>
              <button
                onClick={handleBack}
                className="flex items-center gap-2 text-gray-600 hover:text-[#C41E3A] transition-colors mb-4"
              >
                <ArrowLeft size={20} />
